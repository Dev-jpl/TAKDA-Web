  ...
  <div className="p-6 space-y-8">
    <div className="grid grid-cols-2 gap-4">
        ...
        <div className="bg-background-secondary p-5 rounded-3xl border border-border-primary relative overflow-hidden flex flex-col items-center justify-center">
            ...
            <p className="mt-4 text-[9px] font-black text-text-tertiary uppercase tracking-widest">Today</p>
        </div>
    ...
    <div className="bg-background-secondary p-5 rounded-3xl border border-border-primary overflow-hidden">
        <header className="flex justify-between items-center mb-4">
            ...
            <span className="text-[9px] font-bold text-text-tertiary">On track</span>
        </header>
  ...
  <div className="p-6 space-y-6">
    <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
            ...
            <div>
                <h4 className="text-xs font-black text-text-primary uppercase">Finances</h4>
                <p className="text-[8px] text-text-tertiary font-bold tracking-[0.2em]">April 2026</p>
            </div>
        </div>
    ...
    <div className="space-y-3">
        {[
            { tag: "Rent", val: "-$2,100", date: "Apr 1", icon: Receipt },
            { tag: "Groceries", val: "-$84.20", date: "Apr 2", icon: Receipt },
            { tag: "Subscriptions", val: "-$14.99", date: "Apr 3", icon: Receipt },
        ].map((e, i) => (
            <motion.div
                key={i}
    ...
    <div className="bg-urgent/5 border border-urgent/20 p-4 rounded-2xl flex items-center justify-between">
        <div className="flex items-center gap-3">
            ...
            <div>
                <p className="text-[10px] font-black text-text-primary uppercase">Bill due soon</p>
  ...
  <div className="p-6 h-full flex flex-col">
    <div className="flex-1 space-y-6">
        ...
        <div className="bg-background-tertiary/50 border border-border-primary rounded-2xl p-5 relative overflow-hidden group">
            ...
            <p className="text-[11px] font-bold text-text-primary mb-2">Team sync</p>
            <p className="text-[9px] text-text-tertiary font-bold uppercase">2:00 PM – 3:30 PM · Google Meet</p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4">
            <div className="p-4 bg-modules-automate/5 border border-modules-automate/20 rounded-2xl flex flex-col items-center justify-center text-center">
                ...
                <p className="text-[8px] text-text-tertiary font-bold">Auto-generated</p>
            </div>
            <div className="p-4 bg-background-secondary border border-border-primary rounded-2xl flex flex-col items-center justify-center text-center">
                ...
                <p className="text-[8px] text-text-tertiary font-bold">6 questions left</p>
            </div>
        </div>
        ...
        <div className="mt-4 p-4 border border-border-primary/50 rounded-2xl">
            <div className="flex items-center justify-between mb-2">
                <span className="text-[8px] font-black text-text-tertiary uppercase tracking-widest">Automation activity</span>
